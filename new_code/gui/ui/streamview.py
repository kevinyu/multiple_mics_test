...
class Ui_StreamView(object):
    def setupUi(self, StreamView):
        ...
        self.saveLabel = QtWidgets.QLabel(self.frame)
        ...
        self.gridLayout_2.addWidget(self.saveLabel, 2, 1, 1, 1)
        ...
        self.continuousButton.setChecked(True)
    ...
    def retranslateUi(self, StreamView):
        ...
        self.saveLabel.setText(_translate("StreamView", "Saving data to "))
